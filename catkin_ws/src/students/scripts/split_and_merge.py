...
def callback_scan(msg):
    ...
    #
    DISTANCE_THRESHOLD  = 0.15    #Distance threshold to consider a point as part of a candidate line. Valor inicial 0.15
    MIN_POINTS_COUNTING = 5       #Minimum number of points a line should contain. Valor inicial 5
    RHO_TOLERANCE       = 0.05    #RHO and THETA error tolerance to consider two lines as one. Valor inicial 0.05
    THETA_TOLERANCE     = 0.05	#Valor inicial 0.05
